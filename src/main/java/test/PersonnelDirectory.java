          ...
          switch(choice)
          {
			  ...
			  for(int i =0; i <per.getPersonList().size(); i++)
			  {
				if( per.getPersonList().get(i).getFirst().equals(firstN) &&
						per.getPersonList().get(i).getLast().equals(lastN))
				{
				found = true;
				loc = i;
				}
			  ...
			  if(found)
			  {
				  ...
				  per.getPersonList().get(loc).printNameinFirstOrder();
...
//				  per.getPersonList().get(i).printName(order);
				  ...
				  if (order == 0)
					  per.getPersonList().get(i).printNameinFirstOrder();
				  else if (order == 1)
					  per.getPersonList().get(i).printNameinSecondOrder();
				  else if (order == 2)
					  per.getPersonList().get(i).printNameinThirdOrder();
			  }
